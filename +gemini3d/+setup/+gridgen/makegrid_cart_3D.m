...
[thetactr,phictr] = gemini3d.geog2geomag(p.glat, p.glon, year(xg.time));    %get the magnetic coordinates of the grid center, based on user input
...
[glatgrid,glongrid] = gemini3d.geomag2geog(theta, phi, year(xg.time));
