...
paths = [fullfile(gemini3d.root(), ".."), string(getenv("CMAKE_PREFIX_PATH")), string(getenv("GEMINI_ROOT"))];
bindirs = [".", "bin", "build", "build/bin", "build/Release", "build/RelWithDebInfo", "build/Debug"];
